<?php include('menuadmin.php'); ?>
    ...
    <div class="col-lg-9">
        <header class="jumbotron my-4">
			...
			<p style="color: #FF0000;"> Atenção: Todos os campos são obrigatórios. O formato aceito para o preço deve ser: 00.00 </p>
				...
				<div class="form-row">
					...
					<div class="col-md-6">
					  <div class="form-label-group">
						...
						<input type="text" name="preco" id="Preco" class="form-control" placeholder="R$ Preço" required="required">
					  </div>
					</div>
				</div>
			</div>
