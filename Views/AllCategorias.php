            ...
            <nav>
                <ol class="breadcrumb text-white">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <?php echo $resultado->nome_categoria; ?>Ótimos artigos</li>
                </ol>
            </nav>
        </header>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="alert alert-dark" role="alert">
                        <p class="text-center"><a
                                href="../Categoria?acao=cate&categoria=<?php echo base64_encode($value->id_categoria); ?>"><?php echo $value->nome_categoria; ?></a>
                        </p>
                    </div>
            ...
            <main class="col-md-9">
                <header class="border-bottom mb-4 pb-3">
                    <div class="form-inline">
                        <span class="mr-md-auto"><?php $linhas = $listar_produto->findAllCountProduct($id_categoria);
                                                    echo $linhas; ?>
                        ...
                        <aside class="col-sm-3">
                            <div class="info-aside">
                                <div class="price-wrap">
                                    <span class="price h5">R$<?php echo number_format($value->preco, 2, ',', ' '); ?>
                                    </span>
                                </div>
                                ...
                                <p>
                                    ...
                                    <a href="../Carrinho?acao=add&produto=<?php echo base64_encode($value->id_produto); ?>"
                ...
                <nav aria-label="Navegação de página exemplo">
                    <ul class="pagination">
                        <li class="page-item">
                            <a class="page-link"
                                href="../AllCategorias?acao=cate&categoria=<?php echo base64_encode($value->id_categoria); ?>&pagina=1"
                                aria-label="Anterior">
                        ...
                        <li class="page-item"><a class="page-link"
                                href="../AllCategorias?acao=cate&categoria=<?php echo base64_encode($id_categoria); ?>&pagina=<?php echo $pagina_anterior; ?>"><?php echo $pagina_anterior; ?></a>
                        </li>

                        <li class="page-item active"><a class="page-link"
                                href="../AllCategorias?acao=cate&categoria=<?php echo base64_encode($id_categoria); ?>&pagina=<?php echo $pagina; ?>"><?php echo $pagina; ?>
                                <span class="sr-only">(atual)</span></a>
                        </li>

                        <li class="page-item"><a class="page-link"
                                href="../AllCategorias?acao=cate&categoria=<?php echo base64_encode($id_categoria); ?>&pagina=<?php echo $pagina_posterior; ?>"><?php echo $pagina_posterior; ?></a>
                        </li>
                        <li class="page-item">
                            <a class="page-link"
                                href="../AllCategorias?acao=cate&categoria=<?php echo base64_encode($id_categoria); ?>&pagina=<?php echo $quantidade_linhas; ?>"
                                aria-label="Próximo">
