...
use Infra\Dao\Categorias\ListarCategoriasDb;
		...
		<div class="row">
			...
			<main class="col-md-9">
				...
				<nav aria-label="Navegação de página exemplo">
				  <ul class="pagination">
					<li class="page-item">
					  <a class="page-link" href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=1" aria-label="Anterior">
					...
					<?php
						...
						for($pagina_anterior = $pagina - $maximo_links; $pagina_anterior <= $pagina - 1; $pagina_anterior++) {
							if($pagina_anterior >= 1) { ?>
								<li class="page-item"><a class="page-link" href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $pagina_anterior; ?>"><?php echo $pagina_anterior; ?></a></li>
							<?php }
						}
					?>

					<li class="page-item active"><a class="page-link" href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $pagina; ?>"><?php echo $pagina; ?><span class="sr-only">(atual)</span></a></li>

					<?php
						for($pagina_posterior = $pagina + 1; $pagina_posterior <= $pagina + $maximo_links; $pagina_posterior++) {
							if($pagina_posterior <= $quantidade_linhas) { ?>
								<li class="page-item"><a class="page-link" href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $pagina_posterior; ?>"><?php echo $pagina_posterior; ?></a></li>
							<?php }
						}
					?>
					<li class="page-item">
					  <a class="page-link" href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $quantidade_linhas; ?>" aria-label="Próximo">
