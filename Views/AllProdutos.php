        ...
        <main class="col-md-9">
            <header class="border-bottom mb-4 pb-3">
                <div class="form-inline">
                    <span class="mr-md-auto"><?php $linhas = $listar_produto->findAllCount();
												echo $linhas; ?> itens encontrados</span>
            ...
            <nav aria-label="Navegação de página exemplo">
                <ul class="pagination">
                    <li class="page-item">
                        <a class="page-link"
                            href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=1"
                            aria-label="Anterior">
                    ...
                    <li class="page-item"><a class="page-link"
                            href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $pagina_anterior; ?>"><?php echo $pagina_anterior; ?></a>
                    </li>

                    <li class="page-item active"><a class="page-link"
                            href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $pagina; ?>"><?php echo $pagina; ?><span
                                class="sr-only">(atual)</span></a>
                    </li>


                    <li class="page-item"><a class="page-link"
                            href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $pagina_posterior; ?>"><?php echo $pagina_posterior; ?></a>
                    </li>

                    <li class="page-item">
                        <a class="page-link"
                            href="../Produto?acao=prod&produto=<?php echo base64_encode($value->id_produto); ?>&pagina=<?php echo $quantidade_linhas; ?>"
                            aria-label="Próximo">
