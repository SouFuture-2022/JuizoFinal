...
use App\Infra\Dao\Tamanho\CadastrarTamanhoDb;
                ...
                <div class="col">
                    <div class="card shadow p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-center">
                                    <input type="submit" name="cadastrar_produto" class="btn w-75 btn-outline-primary" value="Cadastrar produto">
                                </div>
                            </div>
                        </form>
                    </div>
...
if (isset($_POST['btCadastrar'])) {
    ...
    if (isset($_POST['produto'])) {
        $produtos = new CadastrarProdutoDb;
        $produtos->insert();
        echo "<script> alert ('Produto cadastrado com sucesso'); window.location='http://localhost:8000/';</script>";
    }
